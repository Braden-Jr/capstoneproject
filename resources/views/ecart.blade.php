...
@section('contents')
    ...
    @else
        <div class="col-sm-8 offset-sm-2 text-center head-heading head-heading-sm pending-login" style="height: 70vh">
            <h2 style="padding-top: 20%">Please click <a href="userLogin" style="text-decoration: underline">here</a> to login. </h2>
        </div>
    @endif
@endsection
